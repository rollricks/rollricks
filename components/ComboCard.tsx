    ...
    >
      ...
      <ul className="flex flex-col gap-1.5 mt-1">
        {combo.items.map((item, idx) => {
          const isVeg =
            combo.type === "veg" || combo.type === "both";
          return (
      ...
      <button
        ...
        className="mt-2 w-full py-2.5 rounded-xl bg-[#FFD600] text-[#09090b] font-bold text-sm hover:brightness-110 active:scale-[0.97] transition-all"
      >
        Add to Cart
      </button>
    </motion.div>
